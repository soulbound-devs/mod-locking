...
public class RequestAllDataC2SPacket {
    ...
    public boolean handle(Supplier<NetworkEvent.Context> sup) {
        ...
        context.enqueueWork(() -> {
            ...
            ModPackets.sendToClient(new SyncAllDataS2CPacket(points, pointPluralNames, pointColors, ModConfigs.UNLOCKS.getAll(), ModConfigs.TREES.trees), context.getSender());
        });
        return true;
    }
}
